using RealityToolkit.DeviceSimulation.CameraService.Interfaces;
...
{
    [System.Runtime.InteropServices.Guid("5d13d6c9-d746-40c8-b6bc-cf80af7b6bf7")]
    public class CameraSimulationService : BaseServiceWithConstructor, ICameraSimulationService
    {
        public CameraSimulationService(string name, uint priority, CameraSimulationServiceProfile profile)
            : base(name, priority)
        {
